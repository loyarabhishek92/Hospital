  ...
  return (
    ...
    <div className="mx-auto px-5 mt-20 max-w-7xl lg:px-8">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-5 mt-10">
        <div className="bg-[#BFD2F8]  py-15 pl-7 rounded-sm flex flex-col justify-center items-center lg:items-start gap-y-1.5">
        ...
        <div className="bg-[#202f72] text-[#BFD2F8] py-15 pl-7 rounded-sm flex flex-col gap-y-1.5 justify-center items-center lg:items-start">
        ...
        <div className="bg-[#BFD2F8] py-15 pl-7 rounded-sm flex flex-col gap-y-1.5 justify-center items-center lg:items-start">
